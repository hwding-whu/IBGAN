...
flags.DEFINE_integer('total_steps', 5000, "total number of training steps")
...
flags.DEFINE_string('logdir', './logs/bloodmnist/GAN', 'log folder')
# generate
flags.DEFINE_bool('generate', False, 'generate images')
flags.DEFINE_string('pretrain', './logs/bloodmnist/GAN/model.pt', 'path to test model')
flags.DEFINE_string('output', './outputs/bloodmnist/GAN', 'path to output dir')
flags.DEFINE_integer('num_images', 100, 'the number of generated images')
...
def train():
    ...
    dataset = ImageFolder("./data/bloodmnist/Training", transform=data_transform)
